    ...
    <>
      ...
      <div className="space-y-2">
        <div className="flex gap-2">
          <label className="flex-1">
            ...
            <input
              ...
              className="w-full text-xs px-2 py-1 bg-gray-800 rounded border border-[var(--accent)] text-white mt-1"
            />
          </label>
          <label className="flex-1">
        ...
        <button
          ...
          disabled={!valid}
          className="w-full text-xs px-3 py-2 bg-[var(--accent)] text-black font-medium rounded hover:opacity-90 transition-opacity disabled:opacity-40"
        >
          Create Room
        </button>
      </div>
